...
define('G5_MYSQL_USER', 'dabong0383');
define('G5_MYSQL_PASSWORD', 'dbdb0383@@');
define('G5_MYSQL_DB', 'dabong0383');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'dabong_');

define('G5_TOKEN_ENCRYPTION_KEY', '227a466b4f4ab66f5be909be05a56c46'); // 토큰 암호화에 사용할 키
