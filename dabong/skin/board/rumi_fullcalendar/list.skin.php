...
$admin_btn = "";
if($is_admin) {
    $admin_btn = "<button type='button' class='fc-button fc-button-primary' id='btn-settings'>설정</button>";
    $admin_btn .= "<button type='button' class='fc-button fc-button-primary' id='btn-adminset'>관리자</button>";
}
...
<div id="bo_list">
    ...
    <div id="calendar" class='h-100 container col-lg-9 mx-auto'></div>
