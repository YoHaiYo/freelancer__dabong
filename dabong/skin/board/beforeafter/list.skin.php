...
<div id="bo_gall">
    ...
    <?php if ($is_category) { ?>
    <nav id="bo_cate" class="d-flex justify-content-center">
        <h2><?php echo $board['bo_subject'] ?> 카테고리</h2>
        <ul id="bo_cate_ul" class='category_orthod d-flex justify-content-center flex-wrap border-activecolor py-3 px-lg-3'>
                ...
                <div class="gall_con">
                    ...
                    <div class="gall_text_href">
                        ...
                        <a href="<?php echo $list[$i]['href'] ?>" class="bo_tit">
                         ...
                         <span class="bo_cnt"><span>Before:</span> <?php echo utf8_strcut(strip_tags($list[$i]['wr_1']), 68, '..'); ?></span>
						 <span class="bo_cnt"><span>After:</span> <?php echo utf8_strcut(strip_tags($list[$i]['wr_2']), 68, '..'); ?></span>
                    </div>
