    ...
    <section id="bo_v_info">
        ...
        <div class="profile_info">
        	...
        	<div class="profile_info_ct">
        		<span class="sound_only">작성자</span> <strong><?php echo $view['name'] ?><br>
...
;
    ...
    <section id="bo_v_atc">
        ...
        if($v_img_count) {
			...
			echo "<em class=\"gall_before gall_badge\">Before</em>";
			echo "<em class=\"gall_after gall_badge\">After</em>";
        ...
        <!-- 본문 내용 시작 { -->
        <div id="bo_v_con">
			<div class="bo_v_wr_box">
				<div class="bo_v_wr bo_v_wr_1">
					<p><?php echo $view['wr_1']; ?></p>
				</div>
				<div class="bo_v_wr bo_v_wr_2">
