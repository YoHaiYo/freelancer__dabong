...
<div class="bo_w_link write_div">
    <label for="wr_1" class="d-inline w-auto position-unset me-4"><span>새창</span></label>
   
    <input type="radio" name="wr_1" <?php if($w=="u" && $write['wr_1'] == "y") { echo "checked"; } ?> value="y" id="wr_1_y">
    <label for="wr_1_y" class="d-inline w-auto position-unset"><span> yes</span></label>
    
    <input type="radio" name="wr_1" <?php if($w=="u" && $write['wr_1'] == "n") { echo "checked"; } ?> value="n" id="wr_1_n">
    <label for="wr_1_n" class="d-inline w-auto position-unset"><span>  no</span></label>
</div>

<div class="bo_w_link write_div">
        <label for="wr_2"><span > 저작정보 </span></label>
