...
<style>
		...
		.subpage_navi + .container h2{ display: none !important}
	</style>
		<?php 
...
?>
        ...
        <div class="">
            <div class="row mx-auto ">
				...
				<article id="bo_v" style="width:<?php echo $width; ?>">
					<div class="title  position-relative container d-md-flex justify-content-between align-items-end">
						<div>
							<h2 id="bo_v_title" class='font26 text-center d-none'>
								<?php if ($category_name) { ?>
									<!-- <span>시술타입</span> -->
								<span class="bo_v_cate font35 fw500 activeColordark bg-white border-0 shadow-none "><?php echo $view['ca_name']; // 분류 출력 끝 ?></span> 
								<?php } ?>							
							</h2>
							<span class="font19 fw400 d-block mb-3 px-5" >
							   <?php if ($category_name) { ?>
									<span>시술타입</span>
								<span class="activeColordark  bar"><?php echo $view['ca_name']; // 분류 출력 끝 ?></span> 
								<?php } ?>								
							</span>
							<span class="font19 fw400 d-block mb-3 px-5" >
								<span >환자성함 </span> 
								<span class='bar'>
									<?php echo hideMiddleChars($view['wr_subject']); ?>
								</span>
							</span>
							<span class="font22 fw400 d-block mb-5  px-5" ><?php echo $view['wr_3']; ?></span>
						</div>
						
						<?php if ($prev_href || $next_href) { ?>
							<div class="position-relative px-5">
							<ul class="bo_v_nb  d-flex justify-content-between align-items-center afterno border-0">
								<li class="btn_prv border-0">
									<?php if ($prev_href) { ?>
										<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-bar-left" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M12.5 15a.5.5 0 0 1-.5-.5v-13a.5.5 0 0 1 1 0v13a.5.5 0 0 1-.5.5M10 8a.5.5 0 0 1-.5.5H3.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L3.707 7.5H9.5a.5.5 0 0 1 .5.5"/>
</svg>
										<a href="<?php echo $prev_href ?>" ><?php //echo $prev_wr_subject;?>이전</a>
										<?php } ?>
								</li>
								<li class='border-0 p-0'><a href="<?php echo $list_href ?>" class="btn_b01 fw700"><i class="fa fa-list" aria-hidden="true"></i> 목록</a></li>
								<?php if ($update_href) { ?><li class='border-0 py-0 px-2'><a href="<?php echo $update_href ?>" class="btn_b01  fw700"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> 수정</a></li><?php } ?>
								<?php if ($delete_href) { ?><li class='border-0 py-0 px-1'><a href="<?php echo $delete_href ?>" class="btn_b01  fw700" onclick="del(this.href); return false;"><i class="far fa-trash-alt"></i> 삭제</a></li><?php } ?>
								<li class="btn_next border-0">
									<?php if ($next_href) { ?>										
										<a href="<?php echo $next_href ?>" ><?php //echo $next_wr_subject;?>다음</a>
  ...
  <path fill-rule="evenodd" d="M6 8a.5.5 0 0 0 .5.5h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L12.293 7.5H6.5A.5.5 0 0 0 6 8m-2.5 7a.5.5 0 0 1-.5-.5v-13a.5.5 0 0 1 1 0v13a.5.5 0 0 1-.5.5"/>
					...
					<section id="bo_v_info" class="d-none">
						<h2>페이지 정보</h2>
					...
					<section id="bo_v_atc">
						...
						<div class='row mx-auto container position-relative'>
							<ul class="bo_v_nb position-absolute start-0 top-0 d-none border-0 bottom-0 px-0 m-0 end-0  justify-content-between align-items-center afterno">
								<li class="btn_prv border-0">
									<?php if ($prev_href) { ?>
										<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-bar-left" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M12.5 15a.5.5 0 0 1-.5-.5v-13a.5.5 0 0 1 1 0v13a.5.5 0 0 1-.5.5M10 8a.5.5 0 0 1-.5.5H3.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L3.707 7.5H9.5a.5.5 0 0 1 .5.5"/>
  ...
  <path fill-rule="evenodd" d="M6 8a.5.5 0 0 0 .5.5h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L12.293 7.5H6.5A.5.5 0 0 0 6 8m-2.5 7a.5.5 0 0 1-.5-.5v-13a.5.5 0 0 1 1 0v13a.5.5 0 0 1-.5.5"/>
							...
							if($v_img_count) {
								echo "<ul id=\"bo_v_img\" class='d-md-flex justify-content-center px-5 m-0'>";
								//전후사진
								if ($view['file'][0]['view']) {
									//echo $view['file'][$i]['view'];
									echo "<li class=' p-3 position-relative'>
									<span class=\"t-ex position-absolute start-0 top-0 text-white  px-3 py-2 beforeColor font19\">시술전</span>"
									.get_view_thumbnail($view['file'][0]['view'])
									."<p class='mt-3'>".$view['wr_1']."</p>"
									."</li>";
								}
								if ($view['file'][1]['view']) {
									//echo $view['file'][$i]['view'];
									echo "<li  class=' p-3 position-relative'>
									<span class=\"t-ex position-absolute start-0 top-0 text-white  px-3 py-2 afterColor font19\">시술후</span>"
									.get_view_thumbnail($view['file'][1]['view'])
									."<p class='mt-3'>".$view['wr_2']."</p>"
									."</li>";
								}
						...
						<!-- 본문 내용 시작 { -->
							<div id="bo_v_con" class='border-top py-4 my-5'>
								<div class="container">
									<h3 class='font26 text-center mb-4'>
										시술과정</h3>
					...
					<div class="container">
						<div id="bo_v_share" class='d-none'>
