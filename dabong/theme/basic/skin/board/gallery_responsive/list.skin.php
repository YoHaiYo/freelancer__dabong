                ...
                <div class="col-sm-12 px-0">
					...
					<div id="bo_gall" style="width:<?php echo $width; ?> " >
						...
						<nav id="bo_cate">
							...
							<ul id="bo_cate_ul" class='justify-content-center d-flex'>
						...
						<!-- 게시판 페이지 정보 및 버튼 시작 { -->
						<div id="bo_btn_top" class="container mx-auto">
						...
						<?php if ($is_checkbox) { ?>
						<div id="gall_allchk" class='container  translate-middle-y-25 mb-4'>
					  ...
					  <section class="wrapper container">
						<!-- maxwidth mx-auto -->
									...
									<?php for ($i=0; $i<count($list); $i++) {
									 ...
									 ?>
										<div class="card-position shadow-none my-4">
											<!-- 체크박스 -->
											<div class="gall_chk">
											<?php if ($is_checkbox) { ?>
											...
											<div class="card h-auto d-lg-flex flex-row  shadow-none border-0">

											   
												<div class='img-card h-auto col-md-8' >
													<ul class='d-md-flex' >
												<?php
													...
													if (!empty($files[0])) { 
														...
														echo '<li class="_before flex-fill  position-relative ">
																...
																<strong class="d-block mt-2 font14 fw400">'.$list[$i]['wr_1'].'</strong>
														      </li>';
													}
												...
												<!-- <?php if ($admin_href) { ?><p> <a href="<?php echo $list[$i]['href'] ?>">관리</a> </p><?php } ?> -->
													<h4 class="card-title d-flex align-items-center">
														...
														<a href="<?php echo $list[$i]['href'] ?>" class='morebtn ms-lg-4 ms-2 active mt-3 mt-lg-0 font14 d-block fw400' style='width:90px; min-width:auto'>더보기</a>
														...
														<ul class='d-md-flex px-0 mb-0'>
															...
															<?php
																if (!empty($files[2])) { 
																	...
																	echo  '<li class="col-md-6 me-md-2"><img src="'.$file_3.'" alt="시술중" class="w-100  d-block" /></li>';
																}
															?>
