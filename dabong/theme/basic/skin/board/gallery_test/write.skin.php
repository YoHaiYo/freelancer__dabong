                ...
                <div class="col-sm-12">
					<section id="bo_w">
						...
						<div class="bo_w_select write_div">
							...
							<select name="ca_name" id="ca_name" class='border-dark bg-white shadow-none' required>
						...
						<div class="bo_w_tit write_div">
							<label for="wr_subject" class="sound_only">환자이름<strong>필수</strong></label>
							
							<div id="autosave_wrapper write_div">
								<input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input required" size="50" maxlength="255" placeholder="환자이름">
						...
						<div class="write_div">
							<label for="wr_content" class='text-center d-block' >첨부파일은 시술전, 시술후, 시술중 순서대로 첨부하시고<br> 여기 내용의 사진첨부는 상세시술에 노출되는 이미지입니다.</label>
						...
						<div class="bo_w_link write_div">
							...
							<input type="text" name="wr_1" value="<?php if($w=="u"){echo$write['wr_1'];} ?>" placeholder="시술전 간략설명" id="wr_1" class="frm_input full_input" size="50">
						</div>
						<div class="bo_w_link write_div">
							
							<input type="text" name="wr_2" value="<?php if($w=="u"){echo$write['wr_2'];} ?>" placeholder="시술후 간략설명" id="wr_2" class="frm_input full_input" size="50">
						</div>
						<div class="bo_w_link write_div">
							
							<input type="text" name="wr_3" value="<?php if($w=="u"){echo$write['wr_3'];} ?>" placeholder="해시태그" id="wr_3" class="frm_input full_input" size="50">
						</div>
						...
						<div class="btn_confirm write_div mb-5 pb-5">
