...
<form name="fboardlist" id="fboardlist" action="./board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post">
													...
													<div class="card-content flex-grow-1 px-0 px-lg-3">
														...
														<h4 class="card-title d-flex align-items-center">
															...
															<a href="<?php echo $list[$i]['href'] ?>" class='me-md-auto'>
																<span class="font19 fw400 d-block" >
																	<?php 
														...
														<div class='wr_content'>
															...
															<p>
															<strong class="d-block mt-lg-3 mt-2 font22 fw300 text-center text-lg-start hashtag"><?php echo $list[$i]['wr_3']?></strong>
															</p>
    ...
    <!-- } 게시판 검색 끝 -->   
						       ...
						       <!-- 게시판 검색 시작 theme/basic_div { -->
<fieldset id="bo_sch" class='mt-4 rounded-0 mb-4'>
        ...
        <select name="sfl" id="sfl">
			<option value="wr_3"<?php echo get_selected($sfl, 'wr_3'); ?>>#해시</option>
			<option value="ca_name"<?php echo get_selected($sfl, 'ca_name'); ?>>치료</option> 
			<option value="wr_1"<?php echo get_selected($sfl, 'wr_1'); ?>>시술전</option>
			<option value="wr_2"<?php echo get_selected($sfl, 'wr_2'); ?>>시술후</option>	
        ...
        <input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" required id="stx" class="sch_input" size="10" maxlength="20" placeholder="검색어를 입력해주세요">
