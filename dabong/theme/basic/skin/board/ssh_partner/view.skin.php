            ...
            <div class="row" style="overflow: hidden;">
                <div class="col-sm-12">
					...
					<article id="bo_v" style="width:<?php echo $width; ?>">
						<header>
							<h2 class="font26 fw400 border-top pt-4">
								<?php if ($category_name) { ?><span class='activeColor'> <?php echo $view['ca_name']; // 분류 출력 끝 ?> </span><?php } ?> 
						...
						<section id="bo_v_atc">
							...
							<div id="bo_v_con">
								<p>
									<span>예약희망일 1</span>
									<span class='bar font19 fw500'><?php echo $view['wr_1']; ?></span>
								 </p>
								 <p>
									<span>예약희망일 2</span>
									<span class='bar font19 fw500'><?php echo $view['wr_2']; ?></span>
								 </p>
								 <p>
									<span>연락처</span>
									<span class='bar font22 fw500 '><?php echo $view['wr_3']; ?></span>
								 </p>
						...
						<!-- 게시물 상단 버튼 시작 { -->
						<div id="bo_v_top" class='border-top'>
							<?php
							ob_start();
							?>
							...
							<ul class="bo_v_nb mt-4 mb-5 pt-5">
								<?php if ($prev_href) { ?><li class="btn_prv"><span class="nb_tit">
									<i class="fa fa-caret-up" aria-hidden="true"></i> 이전글</span><a href="<?php echo $prev_href ?>" class='text-decoration-none'><?php echo $prev_wr_subject;?></a> <span class="nb_date"><?php echo str_replace('-', '.', substr($prev_wr_date, '2', '8')); ?></span></li><?php } ?>
								<?php if ($next_href) { ?><li class="btn_next"><span class="nb_tit">
									<i class="fa fa-caret-down" aria-hidden="true"></i> 다음글</span><a href="<?php echo $next_href ?>" class='text-decoration-none'><?php echo $next_wr_subject;?></a>  <span class="nb_date"><?php echo str_replace('-', '.', substr($next_wr_date, '2', '8')); ?></span></li><?php } ?>
							</ul>
							<?php } ?>
							<?php
