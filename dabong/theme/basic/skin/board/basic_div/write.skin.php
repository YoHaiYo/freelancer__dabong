...
?>
        ...
        <div class="container  mb-5 mt-4">
            <div class="row" style="overflow: hidden;">
                <div class="col-sm-12   px-0" style="overflow-y: auto;">
				...
				<section id="bo_w">
					...
					<?php if ($is_category) { ?>
					<div class="bo_w_select write_div py-3 bg-light ps-4">
						<label for="ca_name"  class="sound_only">분류<strong>필수</strong></label>
						<select name="ca_name" class='bg-white px-4 rounded-0' id="ca_name" required>
					...
					<div class="write_div">
						...
						<input type="text" name="wr_1" value="<?php echo $write['wr_1']; ?>" id="wr_1" class="frm_input full_input" size="50" placeholder="연락처">
					</div>
