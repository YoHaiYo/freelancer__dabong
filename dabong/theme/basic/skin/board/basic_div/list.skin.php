...
<div id="bo_list" class="ks4 mb-5" style="width:<?php echo $width; ?>">
	...
	for ($i=0; $i<count($list); $i++) {
	 ?>
	<!-- 게시물 -->
	<div class="clearfix pr bl d-flex">
		...
		<div class="e_subject flex-grow-1 " >
                <?php if($list[$i]['reply']){?>
		...
		<div class="m_view d-none d-md-block">
			...
			<div class="e_date"><?php echo $list[$i]['datetime2'] ?></div>
		</div>
	</div>
	<?php } ?>
